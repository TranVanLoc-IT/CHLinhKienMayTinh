namespace PM_LKMT.SubForm
{
    partial class OrderForm
    {
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new Size(541, 589);
			panel1.TabIndex = 0;
			// 
			// gridProductSelected
			// 
			gridProductSelected.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			...
			gridProductSelected.Location = new Point(41, 215);
			gridProductSelected.Name = "gridProductSelected";
			gridProductSelected.RowHeadersWidth = 51;
			gridProductSelected.Size = new Size(497, 142);
			...
			txtNote.Location = new Point(141, 384);
			txtNote.Name = "txtNote";
			txtNote.Size = new Size(365, 87);
			txtNote.TabIndex = 16;
			txtNote.Text = "";
			// 
			// label12
			...
			label12.Location = new Point(58, 399);
			...
			cancelBtn.Location = new Point(351, 524);
			...
			deleteBtn.Location = new Point(225, 524);
			...
			createBtn.Location = new Point(97, 527);
			...
			txtTotalPrice.Location = new Point(300, 480);
			txtTotalPrice.Name = "txtTotalPrice";
			txtTotalPrice.Size = new Size(220, 25);
			...
			label6.Location = new Point(200, 483);
			label6.Name = "label6";
			...
			// txtTotalQuantity
			// 
			txtTotalQuantity.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			txtTotalQuantity.Location = new Point(142, 477);
			txtTotalQuantity.Name = "txtTotalQuantity";
			txtTotalQuantity.Size = new Size(108, 27);
			...
			label5.Location = new Point(58, 483);
			label5.Name = "label5";
			...
			// txtCustomerName
			// 
			txtCustomerName.Location = new Point(193, 135);
			...
			groupBox1.Location = new Point(541, 0);
			groupBox1.Name = "groupBox1";
			groupBox1.Size = new Size(386, 290);
			...
			panel3.Location = new Point(169, 26);
			panel3.Name = "panel3";
			...
			// img
			// 
			img.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
			img.BackgroundImageLayout = ImageLayout.Stretch;
			img.Location = new Point(3, 26);
			img.Name = "img";
			img.Size = new Size(168, 136);
			img.TabIndex = 1;
			img.TabStop = false;
			// 
			// panel2
			...
			panel4.Location = new Point(541, 290);
			panel4.Name = "panel4";
			panel4.Size = new Size(386, 299);
			panel4.TabIndex = 3;
			// 
			// button1
			// 
			...
			// searchTxt
			// 
			searchTxt.Anchor = AnchorStyles.Bottom;
			searchTxt.Font = new Font("Times New Roman", 12F);
			searchTxt.Location = new Point(90, 244);
			searchTxt.Name = "searchTxt";
			searchTxt.PlaceholderText = "Tìm kiếm bằng mã hoặc tên";
			searchTxt.Size = new Size(176, 30);
			...
			comboTable.Location = new Point(348, 243);
			...
			label14.Location = new Point(277, 255);
			...
			dataGrid.Size = new Size(418, 232);
			dataGrid.TabIndex = 0;
			// 
			// OrderForm
			// 
